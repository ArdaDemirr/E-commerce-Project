...
import { LucideAngularModule, PackageOpen, Plus, Edit3, Trash2, X, Folder, PlusCircle, CornerDownRight, Tags, Users, Store, RefreshCw, XCircle, CheckCircle, Truck, Hash, Package, Activity, ListOrdered, MessageSquare, Clock, MapPin, Eye, Star, User } from 'lucide-angular';
